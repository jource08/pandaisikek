...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('backend/') ?>">
    ...
    <div class="sidebar-brand-text mx-3">Tenun Pandai Sikek<!--  <sup>2 --></sup></div>
  </a>
  ...
  <li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="<?= base_url('backend/kategori') ?>">Kategori Produk</a>
  ...
  <li class="nav-item">
    ...
    <div id="collapsePesanan" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item" href="utilities-color.html">List Pesanan</a>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Konten Situs:</h6>
        <a class="collapse-item" href="login.html">Tentang</a>
        <a class="collapse-item" href="register.html">Produk</a>
        <a class="collapse-item" href="forgot-password.html">Galeri</a>
        <a class="collapse-item" href="forgot-password.html">Blog</a>
        <a class="collapse-item" href="forgot-password.html">Kontak</a>
