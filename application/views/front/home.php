    ...
    <div class="section-top-border">
                ...
                <div class="progress-table-wrap">
                    <div class="progress-table">
                        ...
                        ?>
                        <div class="table-row">
                            <div class="serial"><?php echo $i+1; ?></div>
                            <div class="country"><?php echo $test[$i]['category'] ?></div>
                            <div class="visit"><?php echo $test[$i]['nama_produk'] ?></div>
                            <div class="percentage"><?php echo $test[$i]['harga'] ?></div>
                            <div class="percentage">
                                <a class="genric-btn info circle arrow"><i class="fa fa-edit"></i></a>
                                <a class="genric-btn danger circle arrow"><i class="fa fa-trash"></i></a>  
                            </div>
                        </div>
                        <?php $i++; } ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-md-6">
                <div class="single_order">
                    <div class="order_thumb">
                        <img src="assets/front/img/order/order-1.png" alt="">
            ...
            <div class="col-xl-4 col-md-6">
                <div class="single_order">
                    <div class="order_thumb">
                        <img src="assets/front/img/order/order-2.png" alt="">
                        <div class="order_prise">
                            <span>10.00</span>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="single_order">
                    <div class="order_thumb">
                        <img src="assets/front/img/order/order-3.png" alt="">
                        <div class="order_prise">
                            <span>10.00</span>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="single_order">
                    <div class="order_thumb">
                        <img src="assets/front/img/order/order-4.png" alt="">
                        <div class="order_prise">
                            <span>10.00</span>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="single_order">
                    <div class="order_thumb">
                        <img src="assets/front/img/order/order-5.png" alt="">
                        <div class="order_prise">
                            <span>10.00</span>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="single_order">
                    <div class="order_thumb">
                        <img src="assets/front/img/order/order-6.png" alt="">
                        <div class="order_prise">
                            <span>10.00</span>
                        </div>
                    </div>
                ...
                <div class="testmonial_active owl-carousel">
                    <div class="single_testmonial d-flex">
                        <div class="testmonial_thumb">
                            <img src="assets/front/img/testmonial/1.png" alt="">
                        </div>
                    ...
                    <div class="single_testmonial d-flex">
                        <div class="testmonial_thumb">
                            <img src="assets/front/img/testmonial/2.png" alt="">
                        </div>
                        <div class="testmonial_author">
                            <h3>Adam Nahan</h3>
                            <span>Chief Customer</span>
        ...
        <div class="row">
                <div class="col-xl-2 col-md-6 col-lg-3">
                    <div class="single_brand">
                        <img src="assets/front/img/brand/1.png" alt="">
                    </div>
                </div>
                <div class="col-xl-2 col-md-6 col-lg-3">
                    <div class="single_brand">
                ...
                <div class="col-xl-2 col-md-6 col-lg-3">
                    <div class="single_brand">
                        <img src="assets/front/img/brand/7.png" alt="">
                    </div>
                </div>
                <div class="col-xl-2 col-md-6 col-lg-3">
                    <div class="single_brand">
                ...
                <div class="col-xl-2 col-md-6 col-lg-3">
                    <div class="single_brand">
                        <img src="assets/front/img/brand/9.png" alt="">
                    </div>
                </div>
                <div class="col-xl-2 col-md-6 col-lg-3">
                    <div class="single_brand">
                ...
                <div class="col-xl-2 col-md-6 col-lg-3">
                    <div class="single_brand">
                        <img src="assets/front/img/brand/8.png" alt="">
                    </div>
                </div>
            </div>
    </div>
